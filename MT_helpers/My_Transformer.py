...
if __name__ == "__main__":
    ...
    transformer.train(dataset_path='data/20230526/formatted_data/', num_epochs=num_epochs)
    transformer.save_model(model_path="Saved_Model/transformer_6fps_yolo_model.pth")
