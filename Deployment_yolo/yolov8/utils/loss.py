...
class ComputeLoss:
    ...
    def set_targets(self, pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, mask_gt):
        self.set_targets_assigner = TaskAlignedAssigner(
            topk=int(os.getenv('YOLOM', 10)),
            num_classes=self.nc,
            alpha=float(os.getenv('YOLOA', 0.5)),
            beta=float(os.getenv('YOLOB', 6.0)))
        return self.set_targets_assigner(pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, mask_gt)
    ...
    def __call__(self, p, targets, img=None, epoch=0):
        ...
        target_labels, target_bboxes, target_scores, fg_mask = self.set_targets(
