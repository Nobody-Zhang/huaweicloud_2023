...
if not pipeline or not filesrc or not decodebin or not videoconvert or not x264enc or not rtph264pay or not udpsink:
    print("Not all elements could be created")
    exit(1)

filesrc.set_property("location", "/home/jetson/DeepStream-Yolo/test.mp4")
udpsink.set_property("host", "127.0.0.1")  # Use 127.0.0.1 for local testing
udpsink.set_property("port", 5000)  # Replace with your desired UDP port
