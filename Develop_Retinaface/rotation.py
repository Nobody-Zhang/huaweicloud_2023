...
def draw_landmarks(frame, bb, points):
    ...
    if eye2box_ratio > 1.5 or eye2box_ratio < 0.88:
        cv2.putText(frame, "Face: not in center of the bounding box", (10, 140), font, 0.4, blue, 1)
    if w2h_ratio < 0.7 or w2h_ratio > 0.9:
        cv2.putText(frame, "Face: long and narrow", (10, 160), font, 0.4, blue, 1)
...
if __name__ == '__main__':
    ...
    image_path = "../Pytorch_Retinaface/curve/1.jpg"
